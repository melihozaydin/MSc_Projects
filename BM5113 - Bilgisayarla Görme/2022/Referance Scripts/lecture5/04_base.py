...
def plot_cv_img(input_image1, input_image2, input_image3):     
    ...
    #plt.savefig('../images/png/harris_corners1.png')
...
def main():
    # read an image 
    img1 = cv2.imread('./images/png/coins.png')
    img2 = cv2.imread('./images/jpg/office_5.jpg')
    img3 = cv2.imread('./images/jpg/hands1.jpg')
